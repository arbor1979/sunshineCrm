...
if(count($rs_a)>0){
   for($i=0;$i<count($rs_a);$i++){
	   ...
	   $module_body .= "<tr class=\"TableBlock\">
						...
						<td nowrap><a href='../../JXC/v_yingkaipiaohuizong_mingxi.php?".base64_encode("supplyid=$rowid")."' target='_blank'>单数:".$num."</a></td>
						<td nowrap valign=\"Middle\" align=\"left\">金额:".$own."</td>
						<td nowrap valign=\"Middle\" align=\"left\">已开:".$huikuan."</td>
						<td nowrap valign=\"Middle\" align=\"left\">待开:".$pay_own."</td>
					  </tr>";
