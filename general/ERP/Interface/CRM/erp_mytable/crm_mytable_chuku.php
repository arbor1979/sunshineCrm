...
if(count($rs_a)>0){
   for($i=0;$i<count($rs_a);$i++){
	   ...
	   $module_body .= "<tr class=\"TableBlock\">
						...
						<td nowrap valign=\"Middle\" align=\"right\"><a href=../../JXC/stockoutmain_newai.php?action=init_default_search&searchfield=billid&searchvalue=".$billid." target=_blank>".$state."</a></td>
