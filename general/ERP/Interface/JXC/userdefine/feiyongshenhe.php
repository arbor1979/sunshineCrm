...
function feiyongshenhe_value_PRIV( $fieldvalue, $fields, $i )
{
		...
		$iflock=returntablefield("feiyongtype", "id", $typeid, "iflock");
				...
				{
				case "0" :
						if($createman==$_SESSION['LOGIN_USER_ID'] && $fields['value'][$i]['shenhestate']=='未审核')
				...
				if ($_SESSION['LOGIN_USER_PRIV']=='1' && $fields['value'][$i]['shenhestate']=='未审核')
				{
